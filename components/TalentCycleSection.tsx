export default function TalentCycleSection() {
  return (
    <section className="py-16 md:py-32 px-6 relative bg-white dark:bg-[#0f0f0f]">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-primary/5 to-transparent" />

      <div className="max-w-7xl mx-auto relative">
        <div className="text-center mb-14 md:mb-24">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-navy-dark dark:text-white mb-4">
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-12 lg:gap-8">
          ...
          {/* Step 1 */}
          <div className="bg-white dark:bg-[#0f0f0f] p-6 sm:p-8 md:p-10 rounded-3xl w-full sm:max-w-sm text-center border border-slate-200 dark:border-white/10 card-shadow group hover:border-primary/50 transition-all">
            ...
            <h4 className="text-xl sm:text-2xl font-bold mb-4 text-navy-dark dark:text-white">Community Engine</h4>
          ...
          {/* Step 2 — highlighted */}
          <div className="bg-white dark:bg-[#0f0f0f] p-6 sm:p-8 md:p-10 rounded-3xl w-full sm:max-w-sm text-center border-2 border-primary card-shadow shadow-primary/10 md:scale-110 z-10">
            ...
            <h4 className="text-xl sm:text-2xl font-bold mb-4 text-navy-dark dark:text-white">Readiness Engine</h4>
            <p className="text-charcoal dark:text-slate-300 text-sm leading-relaxed">
          ...
          <div className="bg-white dark:bg-[#0f0f0f] p-6 sm:p-8 md:p-10 rounded-3xl w-full sm:max-w-sm text-center border border-slate-200 dark:border-white/10 card-shadow group hover:border-primary/50 transition-all">
            ...
            <h4 className="text-xl sm:text-2xl font-bold mb-4 text-navy-dark dark:text-white">Recruiter Marketplace</h4>
            <p className="text-charcoal dark:text-slate-300 text-sm leading-relaxed">
