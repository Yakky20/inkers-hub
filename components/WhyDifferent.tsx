    ...
    <section className="py-32 px-6 bg-white dark:bg-[#0f0f0f]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="text-5xl font-extrabold tracking-tight text-navy-dark dark:text-white">
            Why We&apos;re Different
          </h2>
          <p className="text-charcoal dark:text-slate-300 text-xl leading-relaxed opacity-80">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-100 dark:border-white/10 bg-slate-50/50 dark:bg-white/5">
                  <th className="p-8 text-sm font-bold uppercase tracking-wider text-charcoal/60 dark:text-slate-400">
                    Feature
                  </th>
                  <th className="p-8 text-sm font-bold uppercase tracking-wider text-charcoal/60 dark:text-slate-400">
                    Job Boards
                  </th>
                  <th className="p-8 text-sm font-bold uppercase tracking-wider text-navy-dark dark:text-white bg-primary/5">
                    Inkers Hub
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 dark:divide-white/10">
                {rows.map((row) => (
                  <tr key={row.feature}>
                    <td className="p-8 font-bold text-navy-dark dark:text-white">{row.feature}</td>
                    <td className="p-8 text-charcoal dark:text-slate-300">{row.board}</td>
                    <td className="p-8 font-bold text-navy-dark dark:text-white bg-primary/5">{row.inkers}</td>
                  </tr>
                ))}
              </tbody>
            </table>
